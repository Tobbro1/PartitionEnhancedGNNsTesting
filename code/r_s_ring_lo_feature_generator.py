...
class R_S_Ring_LO_Feature_Generator(Feature_Generator):
    ...
    def __init__(self, dataset: Dataset, r: int, s: int, lo_graph_sizes_range: Tuple[int,int], lo_s: int, node_pred: bool, samples: Optional[List[int]], absolute_path_prefix: str, dataset_write_path: str, dataset_desc: str, use_editmask: bool, result_mmap_dest: str, editmask_mmap_dest: str, properties_path: Optional[str] = None, write_properties_root_path: Optional[str] = None, write_properties_filename: Optional[str] = None, idx_lookup_path: Optional[str] = None, write_idx_lookup_path: Optional[str] = None, write_idx_lookup_filename: Optional[str] = None):
        ...
        self.title_str = f"{self.r}-{self.s}-Ring Lovasz features"
        ...
        self.metadata["result_prop"]["feature_identifier"]["id"] = "r-s-ring_lo"
    ...
    def compute_feature(self, idx: int):
        ...
        theta, S = self.lo_features.compute_lovasz_number(graph = r_s_ring, num_vertices = r_s_ring.num_nodes)
